  ...
  return (
    <div className="signup-container-div">
      <div className="signup-container">
        ...
        <p className="sub-title">Create a free account with your email</p>
        ...
        <p className="sign-up-label">
          Already have an account? <span onClick={() => handleNavigation('/signin')}className="sign-up-link">Log in</span>
        </p>
